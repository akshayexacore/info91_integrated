...
class SharedPreferencesDataProvider {
  ...
  Future<bool> saveShouldAskRatingFor(String agent) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return await prefs.setString(shouldAskRatingFor, agent);
  }

  Future<String> getShouldAskRatingFor() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString(shouldAskRatingFor) ?? '';
  }
